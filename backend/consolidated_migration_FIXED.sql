-- ============================================================================
-- CONSOLIDATED SUPABASE DATABASE MIGRATION (FIXED VERSION)
-- Phase 1: Complete schema consolidation for AgentFlow AI Platform
-- ============================================================================
-- This migration handles existing objects properly using DROP IF EXISTS
-- 
-- Target Tables:
...
-- Date: 2025-12-16
-- Version: Fixed for existing objects
-- ============================================================================
...
-- Drop existing policies
DROP POLICY IF EXISTS "Service role full access" ON public.workflow_executions;
DROP POLICY IF EXISTS "Users can view own workflows" ON public.workflow_executions;
...
-- Drop existing policies
DROP POLICY IF EXISTS "Service role full access" ON public.agent_messages;
DROP POLICY IF EXISTS "Users can view messages from their workflows" ON public.agent_messages;
...
-- Drop existing trigger
DROP TRIGGER IF EXISTS update_agent_messages_updated_at ON public.agent_messages;
...
-- Drop existing policies
DROP POLICY IF EXISTS "Users can manage memory for their conversations" ON public.shared_memory;
...
DROP TRIGGER IF EXISTS update_shared_memory_updated_at ON public.shared_memory;
DROP TRIGGER IF EXISTS update_shared_memory_access ON public.shared_memory;
...
-- Drop existing policies
DROP POLICY IF EXISTS "Service role full access" ON public.model_metrics;
DROP POLICY IF EXISTS "Authenticated read access" ON public.model_metrics;
